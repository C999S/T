...
import webbrowser
webbrowser.open('https://t.me/U_OOS')
#-------------------------------
import os
try:
...
print('''\x1b[38;5;210m  ╰─ \033[1;33m[⌯]  \033[2;32mDEVELOPER  : 𓆩𝐓𝐎𝐌𓆪 المطور
  ...
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTOOL       : INSTA اداه صيد متاحات
...
msg="( انتضر حب الاداه جاي تفحص  🤍)"

print(' ')
ID = input(f' {F}({C}⌯{F}){B} 𝙏𝙀𝙇𝙀 {F} 𝙄𝘿 {X} : {F}  '+C)
print(' ')
print(' ')
token = input(f' {F}({C}⌯{F}){B} 𝘽𝙊𝙏 {F} 𝙏𝙊𝙆𝙀𝙉 {X} : {F}  '+C)
print(' ')
print(' ')
sid = input(f' {F}({C}⌯{F}){F} 𝙎𝙀𝙀𝙎𝙄𝙊𝙉𝙄𝘿 {X} : {F}  '+C)
uid = uuid4()
...
print('''\x1b[38;5;210m  ╰─ \033[1;33m[⌯]  \033[2;32mDEVELOPER  : 𓆩𝐓𝐎𝐌𓆪 المطور
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mMY CHANNEL : @hwxdw
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTOOL       : INSTA اداه صيد متاحات انستا 
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTELEGRAM   : @j4rgs''')  
...
˹♚˼ 𝒅𝒂𝒕𝒂 ➪ {dat}
˹♚˼ 𝒓𝒆𝒔𝒕 ➪ {rs}
˹♚˼ 𝒍𝒊𝒏𝒌 ➪ https://www.instagram.com/{user} 
▬▭▬▭▬▭𓆩𝐓𝐎𝐌𓆪▬▭▬▭▬
 𝗕𝗬 ➪ @j4rgs  | @hwxdw
""")
        print(F+tlg)        
    ...
    if req['message'] == "The username you entered doesn't appear to belong to an account. Please check your username and try again.":
        global count
        count += 1
        print(Y+f' {count}- Bad Insta»{user}@gmail.com' + M, end='\r')
        time.sleep(0.01)
...
def sad(email, user):
    ...
    if res.json()['status'] == 'SUCCESS':
        ...
        global count
        count += 1
        print(f" {M}[ {Z}{count} {M}]-{Z}Bad Gmail:{M}﴾ {Z}{user}@gmail.com {M}﴿        " + M, end='\r')
        time.sleep(0.01)
def users():
